        ...
        {spots.length === 0 ? (
          ...
          <div style={{ display: 'grid', gap: 16, gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))' }}>
            {spots.map((spot) => {
              ...
              return (
                <Link key={spot.id} href={`/map/spot/${spot.slug}`} style={{ textDecoration: 'none' }}>
                  ...
                  >
                    <div style={{ height: 160, background: 'var(--gray-700)', position: 'relative', overflow: 'hidden' }}>
                      {cover
                        ? <img src={cover} alt={`Spot BMX ${spot.name} ${cityLabel}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" />
